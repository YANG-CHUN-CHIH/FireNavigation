...
public class DataCollectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                for (ScanResult scanResult : scanResults) {
                    ...
                    // 收集RSSI值
                    Toast.makeText(DataCollectionActivity.this, "SSID: " + ssid + ", BSSID: " + bssid + ", RSSI: " + rssi, Toast.LENGTH_SHORT).show();
        ...
        StartBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (areaName != null && !areaName.isEmpty()) {
                    ...
                    Toast.makeText(DataCollectionActivity.this, "Please enter an area name", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        finishBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(DataCollectionActivity.this, "Finish Scanning", Toast.LENGTH_SHORT).show();
        ...
        trainBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(DataCollectionActivity.this, "Analyzing Data", Toast.LENGTH_SHORT).show();
